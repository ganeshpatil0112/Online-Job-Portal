...
<title> DreamJobs4U.in | Home</title>
...
<!-- Main Container -->
<div class="container-fluid" style=" background-color: #070166; background-position: center; background-size: cover; background-repeat: no-repeat; background-attachment: fixed;">
    ...
    <div class="hero" style=" color:whitesmoke; height: 1700px;">
      ...
      <!--	images in home page-->
            <div class="floating-area">
                <img class="floating" src="img/homepage.gif" width="50%" style="padding-top:90px; padding-left: 50px; padding-bottom:100px; float: left;"/>
            </div>
             ...
             <!-- Texts in home page with heading and sub texts-->
                  <div class="animated slideInRight">
                   <h1 style="padding-top:250px; padding-right:295px; font-size: 30px; float: right;">
                       <strong style="font-family: 'Schoolbell', cursive; font-family: 'Vollkorn', serif;">Find your dream Job Here!</strong>
                   </h1>
                   
                   <h3 style="padding-top:10px; padding-right:215px; font-size: 20px; color:white; float: right;">
                   Pick the job which you love and <br>get paid for doing what you love.<br>
                   <br> Find the job meant for you. <b style="color: #e9c46a">#DreamJobs4U</b>
                   
                  </h3>
        
                         <div class="butn" style="padding-top:15px; padding-right:525px;float:right;">
                         <button type="button" class="btn" style="width:120px; height:40px;  background-color:#e9c46a; border-radius: 0 !important;"> 
                             <a href = "https://stackroutelearning.com/" style="color:black;">  About us! </a>
                         </button>
                         </div>
            ...
            <div style="width: 100%" class="row" >
		           <div class="col-md-9"  >
                    <div style=" margin-top: 30px; padding-left: 50px;">
                        <h1 id="jbs">Search for Jobs</h1>
                        <form class="example" action="index.php">
                        <input style="color:#000; height:45px; width:800px; border-radius:30px 0px 0px 30px;" type="text" placeholder="     Type here..." name="q">
                        <button type="submit" style="height:45px; width:160px; border-radius:0px 30px 30px 0px; background-color: #084b82; "><i class="fa fa-search bb"></i></button>
                      </form>
                    </div>
                            ...
                            <!----------------------SUM OF POSTS & ACTIVE USERS USING VIEW TABLES--------------------------->
                                        ...
                                        <h3 style="font-family: 'Schoolbell', cursive; font-family: 'Vollkorn', serif; color: #0ee2e6; padding-left:4px;"> Total Jobs Available: <?php echo $numberofposts; ?> </h3>
                                        <?php }} ?>
                                        ...
                                        <h3 style="font-family: 'Schoolbell', cursive; font-family: 'Vollkorn', serif; color: #0ee2e6; padding-left:4px;"> Total Active Users: <?php echo $numberofusers; ?> </h3>
                                        <?php }} ?>
                            <!--------------------------------------------------------------------------------------------->
                            ...
                            if(isset($_GET['category']))
                             ...
                             ?>
                                ...
                                <div class="col-md-4 crd" style="margin: 20px; background-color:#454fba; padding: 20px;">
                                ...
                                <?php }}else{
                                        ...
                                        echo ' <img src="img/err.png" width=600px /> ';
                                        echo '</div>';
                                        } ?>
                            ...
                            <div style=" height: 100vh; " class="col-md-3">
                                ...
                                <div class="animated slideInRight dm"> 
                                    <img class="floating" src="img/rytsrc.png" style="width:300px; height: 300px;"/>
                                </div>
