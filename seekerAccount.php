...
?>
<!-- Main Container -->
<div class="container-fluid" style="background-color:#b9ffd0;">
<?php
include 'connect.php';
 $sid = $_SESSION["sid"];
...
?>
	...
	<div class="hero" >
		...
		<div class="col-md-6">
                    <img src="img/1.png" class="img-circle pc" width="550" style="margin: 20%; box-shadow: 0px 0px 20px #1e1e1e;">
                </div>
		
                    <div style=" height: 100vh; color: black " class="col-md-6" >
                        <h2 style="margin-top:150px;">USER NAME:</h2>
                            ...
                            <br><br>
                            <h2>QUALIFICATION:</h2>
                            <h4><strong><?php echo $qlf; ?></strong></h4>
                            <br><br>
                            <h2>SKILLS:</h2>
                            <h4><strong><?php echo $skills; ?></strong></h4>
                            <br><br>
                    </div>   
	    </div>                       
	</div>
