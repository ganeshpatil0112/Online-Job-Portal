...
?>
<!-- Main Container -->
<div class="container-fluid" style="background-color: #b9c1ff;">
		...
		<div style="width: 100%; padding-left: 50px; padding-right: 50px; " class="row" >
			...
			<div class="col"  >
                            <div class="col-md-6" style="padding-top:50px;">
                             <img src="img/seeker.gif" class="img-circle pc" width="350" style="margin: 15%; box-shadow: 0px 0px 20px #1e1e1e;">
                            </div>
                            
                            <div style="padding-left: 500px; padding-top: 190px;">
                                <div>
                            <h4>USER NAME:</h4>
