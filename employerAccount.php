...
?>
<!-- Main Container -->
<div class="container-fluid" style="background-color:#a0dec2; padding-right: 50px; padding-left: 50px;">
<?php
include 'connect.php';
	...
	<div class="hero" >
	  <div style="width: 100%; padding-left: 50px; padding-right: 50px; " class="row" >
            <div class="col">
                ...
                <img src="img/2.gif" class="floating" width="350" style="margin: 10%;">
                </div>
