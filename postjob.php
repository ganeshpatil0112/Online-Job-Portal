...
?>
<!-- Main Container -->
<div class="container-fluid" style="background-color: #77d1c2;">
            ...
            <form method="post">	
                ...
                <div class="row">
                      ...
                      <div class="col" >
                        ...
                        <div class="form-group">
                            <label for="category"><strong>Job Category</strong></label>
                        ...
                        <div class="form-group">
                            <label for="minexp"><strong>Minimum Experiance</strong></label>
                        ...
                        <div class="form-group">
                             <label for="salary"><strong>Salary Budget</strong></label>
                         ...
                         <div class="form-group">
                             <label for="industry"><strong>Job industry</strong></label>
                        ...
                        <div class="form-group">
                            <label for="desc"><strong>Job requirements</strong></label>
                         ...
                         <div class="form-group">
                              <label for="eType"><strong>Employment Type</strong></label>
                        ...
                        <div class="form-group">
                              <label for="eType"><strong>Status</strong></label>
                              <select type="text" name="status" class="form-control" style="border-radius:0px; height: 50px;" >
                                  <option>Open <?php if($status=='open'){echo "checked='true'";}?> </option>
                                  <option>Close <?php if($status=='closed'){echo "checked='true'";}?> </option>
                              </select>
                        </div>
